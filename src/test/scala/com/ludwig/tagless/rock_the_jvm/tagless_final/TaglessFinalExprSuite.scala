...
import com.ludwig.tagless.rock_the_jvm.tagless_final.{And, B, I, Not, Or, Sum}
import com.ludwig.tagless.rock_the_jvm.tagless_final.Expr.eval

class TaglessFinalExprSuite extends munit.FunSuite {
  test("B") {
